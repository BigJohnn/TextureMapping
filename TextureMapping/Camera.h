...
//camera parameters(这个要自行对相机进行标定)
//#define FX 1058
//#define CX 967
//#define FY 1059
//#define CY 538
...
public:
	...
	Camera(glm::vec3 position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f), GLfloat yaw = -265.0f, GLfloat pitch = 5.0f) : Front(glm::vec3(0.0f, 0.0f, -1.0f)), MovementSpeed(5.0f), MouseSensitivity(0.25f), Zoom(45.0f)
	{
