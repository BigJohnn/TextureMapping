...
///////////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#ifndef DCEL_DCELMesh_h
#define DCEL_DCELMesh_h
...
#define DCELMesh_NULL_ID (std::numeric_limits<unsigned int>::max())

/**
	A class that stores the DCELMesh structure. It the list of the vertices, edges and faces.
    Also, it has some methods for simplify the DCELMesh manipulation.
*/
template<class VertexDataT, class HalfEdgeDataT, class FaceDataT>
class DCELMesh : public aiMesh
{
	typedef DCELMesh<VertexDataT, HalfEdgeDataT, FaceDataT> DCELMeshT;
public:

    typedef VertexT<VertexDataT, HalfEdgeDataT, FaceDataT> DCELVertex;
    ...
    /**
        Creates a new, unused vertex on the DCELMesh.
    ...
    */
    unsigned int createEdge( DCELVertex* origin, Face* face, DCELVertex* twinOrigin, Face* twinFace );

    /**
        Adds a new face to the DCELMesh. The face is bounded by previously
    ...
    */
    inline DCELVertex* getVertex( unsigned int id ) const;

    /**
    	Return the list of vertices.
    */
    inline std::vector<DCELVertex>& getVertices();

    /**
    	Returns the list of vertices, for const operations.
    */
    inline const std::vector<DCELVertex>& getVertices() const;

    /**
    	Returns the current number of vertices stored on the DCELMesh.
    ...
    */
    inline unsigned int getVertexId( const DCELVertex* vertex ) const;
    ...
    */
    ...
    /**
    	Returns the number of faces that this DCELMesh has.
    ...
    */
    ...
    /**
        ...
        DCELMesh. When this DCELMesh is created using the create*Face methods,
    ...
    */
    HalfEdge* getHalfEdge( DCELVertex* vertexA, DCELVertex* vertexB ) const;
    ...
    */
    ...
    /**
    	Returns the number of half-edges of the DCELMesh.
    ...
    */
    ...
    /**
        ...
        In these cases, these triangles are not inserted into the DCELMesh,
    ...
    */
    HalfEdge* findIncidentHalfEdge(DCELVertex* vertex);

    /**
    	Clear the entire DCELMesh, releasing the vertices, faces and half-edges.
    */
    void clear();
	...
	inline void SetUnhandledTrianglesCount(unsigned int value){ this->unhandledTrianglesCount = value; }
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::createVertex( )
{
    this->vertices.push_back( DCELVertex() );
    return this->vertices.size()-1;
};

template<class Vdt, class Hdt, class Fdt>
VertexT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::createGetVertex( )
{
    this->vertices.push_back( DCELVertex() );
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::createFace( HalfEdge* bound )
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::createEdge( DCELVertex* origin, Face* face, DCELVertex* twinOrigin, Face* twinFace )
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::createTriangularFace(unsigned int vId1, unsigned int vId2, unsigned int vId3)
{
    DCELVertex* v1 = this->getVertex(vId1);
    DCELVertex* v2 = this->getVertex(vId2);
    DCELVertex* v3 = this->getVertex(vId3);
    ...
    unsigned int nullFaceId = DCELMesh_NULL_ID;
    ...
    //will create one edge to 'fill' the hole and expand the DCELMesh
	...
	{
		face->getData().indices[0] = vId1;
		face->getData().indices[1] = vId2;
		face->getData().indices[2] = vId3;
	}
...
template<class Vdt, class Hdt, class Fdt>
VertexT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getVertex( unsigned int id ) const
{
    const DCELMeshT::DCELVertex* v = &(this->vertices[id]);
    return const_cast<DCELMeshT::DCELVertex*>(v);
};

template<class Vdt, class Hdt, class Fdt>
std::vector<VertexT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getVertices()
{
    return this->vertices;
};

template<class Vdt, class Hdt, class Fdt>
const std::vector<VertexT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getVertices() const
{
    return this->vertices;
};

template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getNumVertices() const
{
    return this->vertices.size();
};

template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getVertexId(const DCELVertex* vertex) const
{
    const DCELVertex* firstVertex = &(this->vertices[0]);
    ...
    return DCELMesh_NULL_ID;
}

template<class Vdt, class Hdt, class Fdt>
std::vector<FaceT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getFaces( )
{
    return this->faces;
};

template<class Vdt, class Hdt, class Fdt>
const std::vector<FaceT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getFaces( ) const
{
    return this->faces;
};

template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getNumFaces( ) const
{
    return this->faces.size();
}

template<class Vdt, class Hdt, class Fdt>
FaceT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getFace(unsigned int faceId) const
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getFaceId(const Face* face) const
{
...
template<class Vdt, class Hdt, class Fdt>
inline std::vector<HalfEdgeT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getHalfEdges( )
{
    return this->edges;
};

template<class Vdt, class Hdt, class Fdt>
inline const std::vector<HalfEdgeT<Vdt,Hdt,Fdt>>& DCELMesh<Vdt,Hdt,Fdt>::getHalfEdges( ) const
{
    return this->edges;
};

template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getHalfEdge(unsigned int id)
{
...
template<class Vdt, class Hdt, class Fdt>
const HalfEdgeT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getHalfEdge(unsigned int id) const
{
...
template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getHalfEdge(DCELVertex* vertexA, DCELVertex* vertexB) const
{
...
template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::getHalfEdge( unsigned int vertexIdA, unsigned int vertexIdB) const
{
    return getHalfEdge( getVertex(vertexIdA), getVertex(vertexIdB) );
};

template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getHalfEdgeId( HalfEdge* halfEdge) const
{
...
template<class Vdt, class Hdt, class Fdt>
unsigned int DCELMesh<Vdt,Hdt,Fdt>::getNumHalfEdges() const
{
    return this->edges.size();
}

template<class Vdt, class Hdt, class Fdt>
void DCELMesh<Vdt,Hdt,Fdt>::checkAllFaces() const
{
...
template<class Vdt, class Hdt, class Fdt>
void DCELMesh<Vdt,Hdt,Fdt>::checkFace(unsigned int faceId) const
{
...
template<class Vdt, class Hdt, class Fdt>
void DCELMesh<Vdt,Hdt,Fdt>::manageUnhandledTriangles()
{
    ...
    while( !this->unhandledTriangles.empty() )
    {
        if( curTriangle==unhandledTrianglesCount )
        {
            ...
            {
                throw cpp::Exception("There are triangles that cannot be added to the DCELMesh!");
            }
        }
        ...
        if( fid==-1 ) //ajust the number of triangles in case of the triangle was not added to the DCELMesh
        {
            unhandledTrianglesCount--;
        }
...
template<class Vdt, class Hdt, class Fdt>
int DCELMesh<Vdt,Hdt,Fdt>::getNumUnhandledTriangles() const
{
    return this->unhandledTrianglesCount;
}

template<class Vdt, class Hdt, class Fdt>
HalfEdgeT<Vdt,Hdt,Fdt>* DCELMesh<Vdt,Hdt,Fdt>::findIncidentHalfEdge(DCELVertex* vertex)
{
...
template<class Vdt, class Hdt, class Fdt>
void DCELMesh<Vdt,Hdt,Fdt>::clear()
{
    this->vertices.clear();
    this->edges.clear();
    this->faces.clear();
